...
function testDataPipeline() {
    ...
    // const sortedStudents = filteredStudents.sort((a, b) => a.total - b.total);  //  ASC(오름차순)
    const sortedStudents = filteredStudents.sort((a, b) => b.total - a.total);  //  DESC(내림차순)
